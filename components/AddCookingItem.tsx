...
const AddCookingItem: React.FC<AddTodoItemProps> = ({
  setClose,
  refetch,
  date,
}) => {
  ...
  const addItem = () => {
    setClose();
    setDoc(doc(firestore, 'cooking', uuidv4()), {
      ...formData,
  ...
  return (
    <View>
      <Text style={styles.heading}>Add New Cooking Item</Text>

      <Input
        placeholder="Cooking Item"
        style={styles.input}
